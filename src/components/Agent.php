...
class Agent
{
    ...
    // 是否是企业微信浏览器打开
    const MICRO_MESSAGE_WORK_YES = 2;
    ...
    //Mozilla/5.0 (Macintosh; Intel Mac OS X 10_16) AppleWebKit/605.1.15 (KHTML, like Gecko) MicroMessenger/6.8.0(0x16080000) MacWechat/3.0.3(0x13000311) NetType/WIFI WindowsWechat
//Mozilla/5.0 (iPhone; CPU iPhone OS 14_5_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 wxwork/3.1.7 MicroMessenger/7.0.1 Language/zh
